const { readJson, sendJson, sendError, requireEnv, supabaseServer, signToken, hashToken, meetsRules, hashPassword, sendVerificationEmail } = require("../_lib");
...
module.exports = async function handler(req, res) {
  ...
  const token = await signToken({ userId: String(userId), email, purpose: "verify", iat: now, exp }, process.env.AUTH_TOKEN_SECRET);
